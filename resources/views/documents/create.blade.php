                ...
                <div class="p-6 text-gray-900">
                    ...
                    <form method="POST" action="{{ route('documents.store') }}" enctype="multipart/form-data">
                        ...
                        <div class="mt-4">
                            ...
                            <p class="mt-1 text-xs text-gray-500">Max size 200MB. Allowed types: PDF, DOC, DOCX, XLSX, XLS, TXT, ZIP.</p>
                        </div>

                        <div class="mt-4">
                            <label for="is_published" class="inline-flex items-center">
                                <input id="is_published" type="checkbox" name="is_published" value="1" {{ old('is_published') ? 'checked' : '' }} class="rounded border-gray-300 text-indigo-600 shadow-sm focus:ring-indigo-500">
